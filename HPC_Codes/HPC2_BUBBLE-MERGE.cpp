...
// Function to print first few elements of array
...
int main() {
    ...
    cout << "Sequential Merge Sort Time: "
         << measureTime([&](vector<int>& a){ mergeSort(a, 0, size - 1); }, arrCopy) << " ms\n";
    ...
    cout << "Parallel Merge Sort Time: "
         << measureTime([&](vector<int>& a){ parallelMergeSort(a, 0, size - 1); }, arrCopy) << " ms\n";
